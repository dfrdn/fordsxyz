  ...
  <div class="p-6 bg-gray-800">
    ...
    >
      ...
      <div class="flex md:items-center space-x-4">
        <a href="https://github.com/dfrdn" target="_blank">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            ...
            /></svg
        ></a>
        <a href="https://www.facebook.com/pordaaan" target="_blank"
          ><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <path
        ...
        ></a>
        <a
          href="https://www.linkedin.com/in/daniel-john-fordan-64a4071aa/"
          target="_blank"
        >
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <path
